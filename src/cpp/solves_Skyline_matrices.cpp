...
main_ns::Matrices_ns::Matrices_Skyline_cls* skyMatrices = static_cast<main_ns::Matrices_ns::Matrices_Skyline_cls*> (this->Matrices);
  ...
  {
    skyMatrices->K[i] = skyMatrices->K[i] + A0 * skyMatrices->M[i] + A1 * skyMatrices->C[i];
  }
}
